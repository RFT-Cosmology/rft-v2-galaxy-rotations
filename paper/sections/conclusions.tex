...
\begin{itemize}
    ...
    \item \textbf{Mechanism validated}: The acceleration-gated tail is supported by LSB dominance (Figure~\ref{fig:lsb}), ±10\% stability sweeps (Figure~\ref{fig:stability}), ablations (Figure~\ref{fig:ablations}), and rotation-curve galleries (Figure~\ref{fig:gallery}).
